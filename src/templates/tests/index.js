function getTypescriptJestTestContent() {
...
function getJavascriptJestTestContent() {
  return `// Mock the PowerTools
jest.mock('@aws-lambda-powertools/logger', () => ({
  Logger: jest.fn().mockImplementation(() => ({
    info: jest.fn(),
    error: jest.fn()
...
module.exports = {
  getTypescriptJestTestContent,
  getJavascriptJestTestContent
};
